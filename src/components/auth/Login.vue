...
<template>
  <div class="row justify-content-center align-items-center">
    <div class="col-12 col-md-6 col-lg-5">
      <Alert v-if="authentication.error && closeButton" class="alert alert-warning alert-dismissible fade show" :closebutton="closeAlert" />
      <form @submit.prevent="LoginSubmit">
        ...
        <button class="btn btn-primary w-100 py-2" type="submit">
          <span v-if="authentication.loading" class="spinner-border spinner-border-sm" role="status"
