  ...
  <div class="row">
    <div class="col-12">
      <div class="card border-0">
        <div v-if="topicStore.tloading" class="d-flex justify-content-center align-items-center">
        ...
        <div v-else class="card-body">
          ...
          <div class="d-flex">
            <div class="flex-shrink-0">
              <img :src="topicStore.topic?.starter?.avatar ? topicStore.topic?.starter?.avatar : VueImage" alt="..."
